...
//        findPreference(KEY_SECURE).setEnabled(enabled);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // !!! Start New Code !!!
            ...
            alertDialog.setMessage("Are you really want to delete the recorded data in the database");
            ...
            alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Yes",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            String address = sharedPreferences.getString(MainActivity.KEY_ADDRESS, null);
                            new DeleteDataTask(MainActivity.this).execute(address);
                        }
                    });
            alertDialog.show();
        }
